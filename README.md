...
- `working_files_folder/`
  ...
  - `surface_data_mapping.csv` — flags per surface: `surface,use_wells,use_sections,use_maps`.
...
## Mapping notes
- `surface_data_mapping.csv`: for each surface, toggle the use of wells/sections/maps (1/0).
